...
public class TD : ModuleRules
{
    ...
    private void IncrementalBuildNumber(ReadOnlyTargetRules Target) {
        string PROJECT_PATH = Target.ProjectFile.Directory.FullName;
        ...
        string gitHash = getGitHash(Target);
    ...
    private string getGitHash(ReadOnlyTargetRules target) {
        string output = "";
